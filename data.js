...
const COUNTRIES = [
  "United States", "Canada", "Brazil", "United Kingdom", "France", "Germany", "Sweden","Netherlands", "Australia","New Zealand", "Japan", "China", "South Korea","Denmark", "Norway", "Finland", "Spain", "Portugal", "Italy", "Mexico","Argentina", "Chile", "Russia", "Saudi Arabia", "South Africa", "Poland", "India","Turkey", "Belgium","Switzerland", "Austria", "Ireland", "Greece", "Czech Republic","Ukraine", "Hungary", "Romania", "Bulgaria","Croatia", "Slovakia", "Serbia", "Lithuania","Latvia", "Estonia", "Iceland", "Palestine", "United Arab Emirates","Egypt", "Peru", "Colombia","Vietnam", "Thailand", "Philippines", "Malaysia", "Singapore", "Indonesia"
]

const TEAMS = ["Team BDS", "Vitality", "G2 Esports", "NRG", "Dignitas", "Spacestation Gaming", "Rogue", "FaZe Clan", "Endpoint", "FURIA", "Oxygen Esports", "Renegades", "Complexity Gaming", "Team Envy", "Moist Esports", "Pioneers","Version1", "Karmine Corp", "Soniqs", "SMPR Esports", "Evil Geniuses"]